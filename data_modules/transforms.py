...
import numpy as np
try:
    import scipy.misc  # unused; removed in scipy>=1.3
except Exception:
    pass
    ...
    def __call__(self, sample):
        ...
        for key in apply_keys:
            ...
            if key in ['image', 'image_ref']:
                ...
                # rgb_mean_val = torch.mean(sample[key], dim=[1, 2], keepdim=True)
                # scaling_val = 255*0.4 / rgb_mean_val
                # sample[key] = sample[key] * scaling_val
                # mask = (sample[key] > 255)
                # sample[key][mask] = 255            
                # sample[key]=sample[key].to(torch.uint8)
...
#                 # print(val)
#                 # val = TT()(val)
#                 # rgb_mean_val = torch.mean(val, dim=[1, 2], keepdim=True)
#                 # scaling_val = 0.4 / rgb_mean_val
#                 # val = val * scaling_val
#                 # val = ToPILImage()(val)
#                 # print("after")
#                 # print(val)
