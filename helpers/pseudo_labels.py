...
def generate_pseudo_labels(model, datamodule):
    ...
    # # load data
    # with open('./data/conf.pickle', 'rb') as fr:
    #     conf_dict = pickle.load(fr)
    ...
    # with open('./data/conf.pickle','wb') as fw:
    #     pickle.dump(conf_dict, fw)
    ...
    save_dir = os.path.join(
        './data', 'pseudo_labels', 'CMApretrained_pseudo_labels_train_{}_cma_{}_test'.format(dataset_name, model_name))
